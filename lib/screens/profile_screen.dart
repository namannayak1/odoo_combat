                          ...
                          children: [
                            ...
                            ListTile(
                              ...
                              title: const Text('Weight',
                                  style:
                                      TextStyle(fontWeight: FontWeight.w600)),
                              subtitle: Text('${snapshot.data!['weight']}kg',
                                  style: const TextStyle(fontSize: 18)),
                            ),
                            const Divider(),
                            ListTile(
                              ...
                              title: const Text('Height',
                                  style:
                                      TextStyle(fontWeight: FontWeight.w600)),
                              subtitle: Text('${snapshot.data!['height']}cm',
                                  style: const TextStyle(fontSize: 18)),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ListTile(
                              ...
                              title: const Text('Diet Type',
                                  style:
                                      TextStyle(fontWeight: FontWeight.w600)),
                              subtitle: Text(snapshot.data!['deitary_pref'],
                                  style: const TextStyle(fontSize: 18)),
                            ),
                            const Divider(),
                            ListTile(
                          ...
                          children: [
                            ListTile(
                              ...
                              title: const Text('Goals',
                                  style:
                                      TextStyle(fontWeight: FontWeight.w600)),
                              subtitle: Text(snapshot.data!['health_goals'],
                                  style: const TextStyle(fontSize: 18)),
                            ),
                          ],
                        ),
